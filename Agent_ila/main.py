...
if __name__ == "__main__":
    raw_user_query ="In wells 15-F-11 A and 15-F-1 C, which formations were drilled?" #"Which drill bits were used for 8.5 and 17.5 sizes?"
    ...
    for single_user_query in query_preprocess(raw_user_query, client):
        ...
        print(summarizer(client).single_summary(single_user_query, result))
